...
plot.1d color=black title="Implantation" label="Arsenic" min = {0 15} max = {1 20}
...
## ************************************************************************
## Export data to CSVs
print.data outfile=amorfAs.out name=Arsenic
print.data outfile=amorfSb.out name=Antimony
print.data outfile=amorfB.out name=Boron
print.data outfile=amorfP.out name=Phosphorus
